...
# Deploy track presets to UserLibrary (ME Slot templates for Move's preset browser)
qecho "Installing track presets..."
ssh_ableton_with_retry "mkdir -p '/data/UserData/UserLibrary/Track Presets'" || true
ssh_ableton_with_retry "cp /data/UserData/move-anything/presets/track_presets/*.json '/data/UserData/UserLibrary/Track Presets/' 2>/dev/null" || true
